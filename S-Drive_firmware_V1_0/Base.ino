...
/*****************************************************************************
  We sample current every 0.5s and calculate average of last 3 (can be more
  adjust this with temperature rise at those temperatures) if average value is
  larger equal or a bit less then short circuit current raise error
******************************************************************************/
